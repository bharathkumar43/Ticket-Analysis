      ...
      try {
        ...
        if (assignmentRows.length) {
          ...
          state.firstAssignees.push({
            ...
            // The ticket's own resolution-SLA-breach flag (NTA's sla_breached, mapped to `rb`
            // in ntaMapper.js) — distinct from this Shift Lead pipeline's assignment-time SLA
            // (assignedAt - createdAt vs. SHIFT_LEAD_ASSIGN_SLA_MINUTES). null when untracked.
            slaBreached: typeof ticket.rb === 'boolean' ? ticket.rb : null,
          });
        }
